...
class ActionsToolbar extends StatelessWidget {
  ...
  //The size of the share social action
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        _getFollowAction(),
        _getSocialActions(icon: TikTokIcons.heart, title: '3.2m'),
        _getSocialActions(icon: TikTokIcons.chat_bubble, title: '16.4k'),
        _getSocialActions(
